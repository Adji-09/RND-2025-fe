    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form" action="{{ route('user.store') }}" method="POST" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="col-md-12" style="text-align:center;">
                            <div class="shrink-0 my-2 text-center position-relative d-inline-block mx-auto">
                                <img src="{{ URL::asset('assets/images/users/user-dummy-img.jpg')}}" id="image_preview" class="rounded-circle avatar-xl img-thumbnail" alt="Preview" title="Preview" />
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="username" name="username" autocomplete="off" placeholder="Username" onkeyup="checkUsername(); return false;" required>
                            <div class="invalid-feedback">
                                Please enter Username.
                            </div>
                            <span id="msg_username" class="msg_username"></span>
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label">Email <span style="color: red;">*</span></label>
                            <div class="input-group has-validation">
                                <span class="input-group-text" id="inputGroupPrepend">@</span>
                                <input type="email" class="form-control" id="email" name="email" aria-describedby="inputGroupPrepend" placeholder="Email" onkeyup="checkEmail(); return false;" required>
                                <div class="invalid-feedback">
                                    Please enter Email.
                                </div>
                            </div>
                            <span id="msg_email" class="msg_email"></span>
                        </div>
                        <div class="col-md-6">
