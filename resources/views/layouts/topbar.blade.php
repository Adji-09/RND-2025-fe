            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ URL('dashboard') }}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ URL::asset('assets/images/logo/logo-sm.png') }}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ URL::asset('assets/images/logo/logo-sm.png') }}" alt="" height="17">
                        </span>
                    </a>
                ...
                <div class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <h2>{{ Session::get('title_header') }}</h2>
                        <h6 class="text-muted">{{ Session::get('subtitle_header') }}</h6>
                    </div>
                </div>
            </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <img class="rounded-circle header-profile-user" src="{{ Session::get('foto') }}" alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('logout') }}"><i class="bx bx-power-off font-size-16 align-middle me-1"></i><span key="t-logout"> <span key="t-logout">Logout</span></a>
                    </div>
                </div>
            </div>
        </div>
